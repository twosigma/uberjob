...
class AsyncJsonFileStore(AsyncFileStore):
    """
    An async :class:`~uberjob.AsyncValueStore` for storing a JSON-serializable value in a file.
    ...
    async def read(self):
        """Read the JSON value from the file asynchronously."""
    ...
    async def write(self, value) -> None:
        """
        Write a JSON-serializable value to the file asynchronously.
